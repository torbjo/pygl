...
# It was auto-generated on 2016-11-15T10:09:57Z from:
# https://www.opengl.org/registry/oldspecs/glcorearb.h
...
# STRING = c_char_p
# Use STRING instead of POINTER(GLchar) ?
# c_char_p implies null-terminated string??
...
glBindAttribLocation.argtypes = (GLuint, GLuint, POINTER(GLchar),)
...
glGetActiveAttrib.argtypes = (GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLint), POINTER(GLenum), POINTER(GLchar),)

glGetActiveUniform = _gl.glGetActiveUniform
glGetActiveUniform.restype = None
glGetActiveUniform.argtypes = (GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLint), POINTER(GLenum), POINTER(GLchar),)
...
glGetAttribLocation.argtypes = (GLuint, POINTER(GLchar),)
...
glGetProgramInfoLog.argtypes = (GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)
...
glGetShaderSource.argtypes = (GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)

glGetUniformLocation = _gl.glGetUniformLocation
glGetUniformLocation.restype = GLint
glGetUniformLocation.argtypes = (GLuint, POINTER(GLchar),)
...
glShaderSource.argtypes = (GLuint, GLsizei, POINTER(POINTER(GLchar)), POINTER(GLint),)
...
glTransformFeedbackVaryings.argtypes = (GLuint, GLsizei, POINTER(POINTER(GLchar)), GLenum,)

glGetTransformFeedbackVarying = _gl.glGetTransformFeedbackVarying
glGetTransformFeedbackVarying.restype = None
glGetTransformFeedbackVarying.argtypes = (GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLsizei), POINTER(GLenum), POINTER(GLchar),)
...
glBindFragDataLocation.argtypes = (GLuint, GLuint, POINTER(GLchar),)

glGetFragDataLocation = _gl.glGetFragDataLocation
glGetFragDataLocation.restype = GLint
glGetFragDataLocation.argtypes = (GLuint, POINTER(GLchar),)
...
glGetUniformIndices.argtypes = (GLuint, GLsizei, POINTER(POINTER(GLchar)), POINTER(GLuint),)
...
glGetActiveUniformName.argtypes = (GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)

glGetUniformBlockIndex = _gl.glGetUniformBlockIndex
glGetUniformBlockIndex.restype = GLuint
glGetUniformBlockIndex.argtypes = (GLuint, POINTER(GLchar),)
...
glGetActiveUniformBlockName.argtypes = (GLuint, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)
...
glBindFragDataLocationIndexed.argtypes = (GLuint, GLuint, GLuint, POINTER(GLchar),)

glGetFragDataIndex = _gl.glGetFragDataIndex
glGetFragDataIndex.restype = GLint
glGetFragDataIndex.argtypes = (GLuint, POINTER(GLchar),)
...
glVertexP2ui = _gl.glVertexP2ui
glVertexP2ui.restype = None
glVertexP2ui.argtypes = (GLenum, GLuint,)

glVertexP2uiv = _gl.glVertexP2uiv
glVertexP2uiv.restype = None
glVertexP2uiv.argtypes = (GLenum, POINTER(GLuint),)

glVertexP3ui = _gl.glVertexP3ui
glVertexP3ui.restype = None
glVertexP3ui.argtypes = (GLenum, GLuint,)

glVertexP3uiv = _gl.glVertexP3uiv
glVertexP3uiv.restype = None
glVertexP3uiv.argtypes = (GLenum, POINTER(GLuint),)

glVertexP4ui = _gl.glVertexP4ui
glVertexP4ui.restype = None
glVertexP4ui.argtypes = (GLenum, GLuint,)

glVertexP4uiv = _gl.glVertexP4uiv
glVertexP4uiv.restype = None
glVertexP4uiv.argtypes = (GLenum, POINTER(GLuint),)

glTexCoordP1ui = _gl.glTexCoordP1ui
glTexCoordP1ui.restype = None
glTexCoordP1ui.argtypes = (GLenum, GLuint,)

glTexCoordP1uiv = _gl.glTexCoordP1uiv
glTexCoordP1uiv.restype = None
glTexCoordP1uiv.argtypes = (GLenum, POINTER(GLuint),)

glTexCoordP2ui = _gl.glTexCoordP2ui
glTexCoordP2ui.restype = None
glTexCoordP2ui.argtypes = (GLenum, GLuint,)

glTexCoordP2uiv = _gl.glTexCoordP2uiv
glTexCoordP2uiv.restype = None
glTexCoordP2uiv.argtypes = (GLenum, POINTER(GLuint),)

glTexCoordP3ui = _gl.glTexCoordP3ui
glTexCoordP3ui.restype = None
glTexCoordP3ui.argtypes = (GLenum, GLuint,)

glTexCoordP3uiv = _gl.glTexCoordP3uiv
glTexCoordP3uiv.restype = None
glTexCoordP3uiv.argtypes = (GLenum, POINTER(GLuint),)

glTexCoordP4ui = _gl.glTexCoordP4ui
glTexCoordP4ui.restype = None
glTexCoordP4ui.argtypes = (GLenum, GLuint,)

glTexCoordP4uiv = _gl.glTexCoordP4uiv
glTexCoordP4uiv.restype = None
glTexCoordP4uiv.argtypes = (GLenum, POINTER(GLuint),)

glMultiTexCoordP1ui = _gl.glMultiTexCoordP1ui
glMultiTexCoordP1ui.restype = None
glMultiTexCoordP1ui.argtypes = (GLenum, GLenum, GLuint,)

glMultiTexCoordP1uiv = _gl.glMultiTexCoordP1uiv
glMultiTexCoordP1uiv.restype = None
glMultiTexCoordP1uiv.argtypes = (GLenum, GLenum, POINTER(GLuint),)

glMultiTexCoordP2ui = _gl.glMultiTexCoordP2ui
glMultiTexCoordP2ui.restype = None
glMultiTexCoordP2ui.argtypes = (GLenum, GLenum, GLuint,)

glMultiTexCoordP2uiv = _gl.glMultiTexCoordP2uiv
glMultiTexCoordP2uiv.restype = None
glMultiTexCoordP2uiv.argtypes = (GLenum, GLenum, POINTER(GLuint),)

glMultiTexCoordP3ui = _gl.glMultiTexCoordP3ui
glMultiTexCoordP3ui.restype = None
glMultiTexCoordP3ui.argtypes = (GLenum, GLenum, GLuint,)

glMultiTexCoordP3uiv = _gl.glMultiTexCoordP3uiv
glMultiTexCoordP3uiv.restype = None
glMultiTexCoordP3uiv.argtypes = (GLenum, GLenum, POINTER(GLuint),)

glMultiTexCoordP4ui = _gl.glMultiTexCoordP4ui
glMultiTexCoordP4ui.restype = None
glMultiTexCoordP4ui.argtypes = (GLenum, GLenum, GLuint,)

glMultiTexCoordP4uiv = _gl.glMultiTexCoordP4uiv
glMultiTexCoordP4uiv.restype = None
glMultiTexCoordP4uiv.argtypes = (GLenum, GLenum, POINTER(GLuint),)

glNormalP3ui = _gl.glNormalP3ui
glNormalP3ui.restype = None
glNormalP3ui.argtypes = (GLenum, GLuint,)

glNormalP3uiv = _gl.glNormalP3uiv
glNormalP3uiv.restype = None
glNormalP3uiv.argtypes = (GLenum, POINTER(GLuint),)

glColorP3ui = _gl.glColorP3ui
glColorP3ui.restype = None
glColorP3ui.argtypes = (GLenum, GLuint,)

glColorP3uiv = _gl.glColorP3uiv
glColorP3uiv.restype = None
glColorP3uiv.argtypes = (GLenum, POINTER(GLuint),)

glColorP4ui = _gl.glColorP4ui
glColorP4ui.restype = None
glColorP4ui.argtypes = (GLenum, GLuint,)

glColorP4uiv = _gl.glColorP4uiv
glColorP4uiv.restype = None
glColorP4uiv.argtypes = (GLenum, POINTER(GLuint),)

glSecondaryColorP3ui = _gl.glSecondaryColorP3ui
glSecondaryColorP3ui.restype = None
glSecondaryColorP3ui.argtypes = (GLenum, GLuint,)

glSecondaryColorP3uiv = _gl.glSecondaryColorP3uiv
glSecondaryColorP3uiv.restype = None
glSecondaryColorP3uiv.argtypes = (GLenum, POINTER(GLuint),)
...
glGetSubroutineUniformLocation.argtypes = (GLuint, GLenum, POINTER(GLchar),)

glGetSubroutineIndex = _gl.glGetSubroutineIndex
glGetSubroutineIndex.restype = GLuint
glGetSubroutineIndex.argtypes = (GLuint, GLenum, POINTER(GLchar),)
...
glGetActiveSubroutineUniformName.argtypes = (GLuint, GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)

glGetActiveSubroutineName = _gl.glGetActiveSubroutineName
glGetActiveSubroutineName.restype = None
glGetActiveSubroutineName.argtypes = (GLuint, GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)
...
glCreateShaderProgramv.argtypes = (GLenum, GLsizei, POINTER(POINTER(GLchar)),)
...
glGetProgramPipelineInfoLog.argtypes = (GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)
...
glDebugMessageInsert.argtypes = (GLenum, GLenum, GLuint, GLenum, GLsizei, POINTER(GLchar),)
...
glGetDebugMessageLog.argtypes = (GLuint, GLsizei, POINTER(GLenum), POINTER(GLenum), POINTER(GLuint), POINTER(GLenum), POINTER(GLsizei), POINTER(GLchar),)

glPushDebugGroup = _gl.glPushDebugGroup
glPushDebugGroup.restype = None
glPushDebugGroup.argtypes = (GLenum, GLuint, GLsizei, POINTER(GLchar),)
...
glObjectLabel.argtypes = (GLenum, GLuint, GLsizei, POINTER(GLchar),)

glGetObjectLabel = _gl.glGetObjectLabel
glGetObjectLabel.restype = None
glGetObjectLabel.argtypes = (GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)

glObjectPtrLabel = _gl.glObjectPtrLabel
glObjectPtrLabel.restype = None
glObjectPtrLabel.argtypes = (POINTER(None), GLsizei, POINTER(GLchar),)

glGetObjectPtrLabel = _gl.glGetObjectPtrLabel
glGetObjectPtrLabel.restype = None
glGetObjectPtrLabel.argtypes = (POINTER(None), GLsizei, POINTER(GLsizei), POINTER(GLchar),)
...
glClearNamedBufferDataEXT = _gl.glClearNamedBufferDataEXT
glClearNamedBufferDataEXT.restype = None
glClearNamedBufferDataEXT.argtypes = (GLuint, GLenum, GLenum, GLenum, POINTER(None),)

glClearNamedBufferSubDataEXT = _gl.glClearNamedBufferSubDataEXT
glClearNamedBufferSubDataEXT.restype = None
glClearNamedBufferSubDataEXT.argtypes = (GLuint, GLenum, GLenum, GLenum, GLsizeiptr, GLsizeiptr, POINTER(None),)
...
glVertexArrayBindVertexBufferEXT = _gl.glVertexArrayBindVertexBufferEXT
glVertexArrayBindVertexBufferEXT.restype = None
glVertexArrayBindVertexBufferEXT.argtypes = (GLuint, GLuint, GLuint, GLintptr, GLsizei,)

glVertexArrayVertexAttribFormatEXT = _gl.glVertexArrayVertexAttribFormatEXT
glVertexArrayVertexAttribFormatEXT.restype = None
glVertexArrayVertexAttribFormatEXT.argtypes = (GLuint, GLuint, GLint, GLenum, GLboolean, GLuint,)

glVertexArrayVertexAttribIFormatEXT = _gl.glVertexArrayVertexAttribIFormatEXT
glVertexArrayVertexAttribIFormatEXT.restype = None
glVertexArrayVertexAttribIFormatEXT.argtypes = (GLuint, GLuint, GLint, GLenum, GLuint,)

glVertexArrayVertexAttribLFormatEXT = _gl.glVertexArrayVertexAttribLFormatEXT
glVertexArrayVertexAttribLFormatEXT.restype = None
glVertexArrayVertexAttribLFormatEXT.argtypes = (GLuint, GLuint, GLint, GLenum, GLuint,)

glVertexArrayVertexAttribBindingEXT = _gl.glVertexArrayVertexAttribBindingEXT
glVertexArrayVertexAttribBindingEXT.restype = None
glVertexArrayVertexAttribBindingEXT.argtypes = (GLuint, GLuint, GLuint,)

glVertexArrayVertexBindingDivisorEXT = _gl.glVertexArrayVertexBindingDivisorEXT
glVertexArrayVertexBindingDivisorEXT.restype = None
glVertexArrayVertexBindingDivisorEXT.argtypes = (GLuint, GLuint, GLuint,)
...
glNamedFramebufferParameteriEXT = _gl.glNamedFramebufferParameteriEXT
glNamedFramebufferParameteriEXT.restype = None
glNamedFramebufferParameteriEXT.argtypes = (GLuint, GLenum, GLint,)

glGetNamedFramebufferParameterivEXT = _gl.glGetNamedFramebufferParameterivEXT
glGetNamedFramebufferParameterivEXT.restype = None
glGetNamedFramebufferParameterivEXT.argtypes = (GLuint, GLenum, POINTER(GLint),)
...
glGetProgramResourceIndex.argtypes = (GLuint, GLenum, POINTER(GLchar),)

glGetProgramResourceName = _gl.glGetProgramResourceName
glGetProgramResourceName.restype = None
glGetProgramResourceName.argtypes = (GLuint, GLenum, GLuint, GLsizei, POINTER(GLsizei), POINTER(GLchar),)
...
glGetProgramResourceLocation.argtypes = (GLuint, GLenum, POINTER(GLchar),)

glGetProgramResourceLocationIndex = _gl.glGetProgramResourceLocationIndex
glGetProgramResourceLocationIndex.restype = GLint
glGetProgramResourceLocationIndex.argtypes = (GLuint, GLenum, POINTER(GLchar),)
...
glTextureBufferRangeEXT = _gl.glTextureBufferRangeEXT
glTextureBufferRangeEXT.restype = None
glTextureBufferRangeEXT.argtypes = (GLuint, GLenum, GLenum, GLuint, GLintptr, GLsizeiptr,)
...
glTextureStorage2DMultisampleEXT = _gl.glTextureStorage2DMultisampleEXT
glTextureStorage2DMultisampleEXT.restype = None
glTextureStorage2DMultisampleEXT.argtypes = (GLuint, GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean,)

glTextureStorage3DMultisampleEXT = _gl.glTextureStorage3DMultisampleEXT
glTextureStorage3DMultisampleEXT.restype = None
glTextureStorage3DMultisampleEXT.argtypes = (GLuint, GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean,)
